...
<div class="col text-center bg-white ">
  ...
  <div class="mb-3">
    <input type="text" name="nombre"; class="form-control" id="examplenombre1" placeholder="Nombre">
  </div>
  <div class="mb-3">
    <input type="text" name="phone"; class="form-control" id="examplephone" placeholder="Phone">
  </div>
  <div class="mb-3">
...
<div class="text-center mt-3">
                    <span>Adready a member?</span><a href="login.php" type="" class='link-offset-2 link-underline link-underline-opacity-0'>LOGIN</a>
                </div>
</div>
<div class="col"></div>
    </div>
