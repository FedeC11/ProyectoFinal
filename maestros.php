  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h1 class="modal-title fs-5" id="exampleModalLabel">Ingresa los datos del Maestro</h1>
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
      </div>
      <div class="modal-body">
      <form action="insertarMaestros.php" method="POST">
                        <div class="mb-3">
                            </div>
                            <div class="mb-3">
...
<table class="table">
                    ...
                    <div class="modal-dialog">
                        ...
                        <div class="modal-body">
                        <form action="editarMaestro.php" method="POST">
                        <div class="mb-3">
                                <label for="exampleInputEmail1" class="form-label">Id</label>
                                <input type="number" class="form-control" name="id_maestro" readonly value="<?php echo $resultado['id']?>">
                            </div>
                            <div class="mb-3">
                                <label for="exampleInputEmail1" class="form-label">Nombre</label>
                        ...
                        <div class="modal-footer">
                            ...
                            <button type="submit" class="btn btn-success">Añadir
                                  ...
                                  <a href="eliminarMaestro.php?Id=<?php echo $resultado['id']?>"  class=" btn btn-danger">Eliminar</a>
                                </td>
                              </tr>
